...
const { entries: dt, setPrototypeOf: at, isFrozen: Wt, getPrototypeOf: Bt, getOwnPropertyDescriptor: Yt } = Object;
let { freeze: S, seal: y, create: Tt } = Object, { apply: Ce, construct: we } = typeof Reflect < "u" && Reflect;
S || (S = function(o) {
  return o;
});
y || (y = function(o) {
...
function w(r) {
  const o = Tt(null);
  for (const [l, s] of dt(r)) L(r, l) && (Array.isArray(s) ? o[l] = Kt(s) : s && typeof s == "object" && s.constructor === Object ? o[l] = w(s) : o[l] = s);
  return o;
}
function K(r, o) {
  for (; r !== null; ) {
...
var mt = Object.freeze({ __proto__: null, ARIA_ATTR: on, ATTR_WHITESPACE: rn, CUSTOM_ELEMENT: sn, DATA_ATTR: nn, DOCTYPE_NAME: Et, ERB_EXPR: en, IS_ALLOWED_URI: _t, IS_SCRIPT_OR_DATA: an, MUSTACHE_EXPR: Qt, TMPLIT_EXPR: tn });
const Z = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 }, ln = function() {
  ...
  try {
    return o.createPolicy(b, { createHTML(x) {
      return x;
    }, createScriptURL(x) {
      return x;
    } });
...
function gt() {
  ...
  const o = (i) => gt(i);
  if (o.version = "3.2.5", o.removed = [], !r || !r.document || r.document.nodeType !== Z.document || !r.Element) return o.isSupported = false, o;
  let { document: l } = r;
  const s = l, T = s.currentScript, { DocumentFragment: b, HTMLTemplateElement: x, Node: fe, Element: xe, NodeFilter: z, NamedNodeMap: ht = r.NamedNodeMap || r.MozNamedAttrMap, HTMLFormElement: At, DOMParser: St, trustedTypes: J } = r, G = xe.prototype, Rt = K(G, "cloneNode"), Ot = K(G, "remove"), yt = K(G, "nextSibling"), Lt = K(G, "childNodes"), Q = K(G, "parentNode");
  if (typeof x == "function") {
    const i = l.createElement("template");
    i.content && i.content.ownerDocument && (l = i.content.ownerDocument);
  }
  let E, W = "";
  const { implementation: ue, createNodeIterator: Nt, createDocumentFragment: Dt, getElementsByTagName: bt } = l, { importNode: It } = s;
  let g = pt();
  o.isSupported = typeof dt == "function" && typeof Q == "function" && ue && ue.createHTMLDocument !== void 0;
  const { MUSTACHE_EXPR: me, ERB_EXPR: pe, TMPLIT_EXPR: de, DATA_ATTR: Mt, ARIA_ATTR: Ct, IS_SCRIPT_OR_DATA: wt, ATTR_WHITESPACE: Pe, CUSTOM_ELEMENT: xt } = mt;
  let { IS_ALLOWED_URI: ve } = mt, u = null;
  const ke = a({}, [...lt, ...De, ...be, ...Ie, ...ct]);
  let p = null;
  const Ue = a({}, [...ft, ...Me, ...ut, ...le]);
  let f = Object.seal(Tt(null, { tagNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, allowCustomizedBuiltInElements: { writable: true, configurable: false, enumerable: true, value: false } })), B = null, Te = null, Fe = true, _e = true, He = false, ze = true, P = false, Ee = true, C = false, ge = false, he = false, v = false, ee = false, te = false, Ge = true, We = false;
  const Pt = "user-content-";
  let Ae = true, Y = false, k = {}, U = null;
  ...
  const Ht = l.createElement("form"), Ve = function(e) {
    ...
    if (!(H && H === e)) {
      if ((!e || typeof e != "object") && (e = {}), e = w(e), X = Ut.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Ft : e.PARSER_MEDIA_TYPE, m = X === "application/xhtml+xml" ? Ne : ce, u = L(e, "ALLOWED_TAGS") ? a({}, e.ALLOWED_TAGS, m) : ke, p = L(e, "ALLOWED_ATTR") ? a({}, e.ALLOWED_ATTR, m) : Ue, Oe = L(e, "ALLOWED_NAMESPACES") ? a({}, e.ALLOWED_NAMESPACES, Ne) : vt, Se = L(e, "ADD_URI_SAFE_ATTR") ? a(w(je), e.ADD_URI_SAFE_ATTR, m) : je, Ye = L(e, "ADD_DATA_URI_TAGS") ? a(w(Xe), e.ADD_DATA_URI_TAGS, m) : Xe, U = L(e, "FORBID_CONTENTS") ? a({}, e.FORBID_CONTENTS, m) : Be, B = L(e, "FORBID_TAGS") ? a({}, e.FORBID_TAGS, m) : {}, Te = L(e, "FORBID_ATTR") ? a({}, e.FORBID_ATTR, m) : {}, k = L(e, "USE_PROFILES") ? e.USE_PROFILES : false, Fe = e.ALLOW_ARIA_ATTR !== false, _e = e.ALLOW_DATA_ATTR !== false, He = e.ALLOW_UNKNOWN_PROTOCOLS || false, ze = e.ALLOW_SELF_CLOSE_IN_ATTR !== false, P = e.SAFE_FOR_TEMPLATES || false, Ee = e.SAFE_FOR_XML !== false, C = e.WHOLE_DOCUMENT || false, v = e.RETURN_DOM || false, ee = e.RETURN_DOM_FRAGMENT || false, te = e.RETURN_TRUSTED_TYPE || false, he = e.FORCE_BODY || false, Ge = e.SANITIZE_DOM !== false, We = e.SANITIZE_NAMED_PROPS || false, Ae = e.KEEP_CONTENT !== false, Y = e.IN_PLACE || false, ve = e.ALLOWED_URI_REGEXP || _t, F = e.NAMESPACE || I, ie = e.MATHML_TEXT_INTEGRATION_POINTS || ie, ae = e.HTML_INTEGRATION_POINTS || ae, f = e.CUSTOM_ELEMENT_HANDLING || {}, e.CUSTOM_ELEMENT_HANDLING && Ve(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (f.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck), e.CUSTOM_ELEMENT_HANDLING && Ve(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (f.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), e.CUSTOM_ELEMENT_HANDLING && typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (f.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), P && (_e = false), ee && (v = true), k && (u = a({}, ct), p = [], k.html === true && (a(u, lt), a(p, ft)), k.svg === true && (a(u, De), a(p, Me), a(p, le)), k.svgFilters === true && (a(u, be), a(p, Me), a(p, le)), k.mathMl === true && (a(u, Ie), a(p, ut), a(p, le))), e.ADD_TAGS && (u === ke && (u = w(u)), a(u, e.ADD_TAGS, m)), e.ADD_ATTR && (p === Ue && (p = w(p)), a(p, e.ADD_ATTR, m)), e.ADD_URI_SAFE_ATTR && a(Se, e.ADD_URI_SAFE_ATTR, m), e.FORBID_CONTENTS && (U === Be && (U = w(U)), a(U, e.FORBID_CONTENTS, m)), Ae && (u["#text"] = true), C && a(u, ["html", "head", "body"]), u.table && (a(u, ["tbody"]), delete B.tbody), e.TRUSTED_TYPES_POLICY) {
      ...
      } else E === void 0 && (E = cn(J, T)), E !== null && typeof W == "string" && (W = E.createHTML(""));
      S && S(e), H = e;
    }
    ...
    if (t.removeAttribute(e), e === "is") if (v || ee) try {
      N(t);
    } catch {
    }
    else try {
    ...
    return Nt.call(e.ownerDocument || e, e, z.SHOW_ELEMENT | z.SHOW_COMMENT | z.SHOW_TEXT | z.SHOW_PROCESSING_INSTRUCTION | z.SHOW_CDATA_SECTION, null);
  }, Le = function(e) {
  ...
  const Qe = function(e) {
    let t = null;
    if (M(g.beforeSanitizeElements, e, null), Le(e)) return N(e), true;
    const n = m(e.nodeName);
    if (M(g.uponSanitizeElement, e, { tagName: n, allowedTags: u }), e.hasChildNodes() && !Je(e.firstElementChild) && A(/<[/\w!]/g, e.innerHTML) && A(/<[/\w!]/g, e.textContent) || e.nodeType === Z.progressingInstruction || Ee && e.nodeType === Z.comment && A(/<[/\w]/g, e.data)) return N(e), true;
    if (!u[n] || B[n]) {
      if (!B[n] && tt(n) && (f.tagNameCheck instanceof RegExp && A(f.tagNameCheck, n) || f.tagNameCheck instanceof Function && f.tagNameCheck(n))) return false;
      if (Ae && !U[n]) {
    ...
    return e instanceof xe && !zt(e) || (n === "noscript" || n === "noembed" || n === "noframes") && A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (N(e), true) : (P && e.nodeType === Z.text && (t = e.textContent, se([me, pe, de], (c) => {
      t = $(t, c, " ");
    }), e.textContent !== t && (V(o.removed, { element: e.cloneNode() }), e.textContent = t)), M(g.afterSanitizeElements, e, null), false);
  }, et = function(e, t, n) {
    if (Ge && (t === "id" || t === "name") && (n in l || n in Ht)) return false;
    if (!(_e && !Te[t] && A(Mt, t))) {
      if (!(Fe && A(Ct, t))) {
        if (!p[t] || Te[t]) {
          if (!(tt(e) && (f.tagNameCheck instanceof RegExp && A(f.tagNameCheck, e) || f.tagNameCheck instanceof Function && f.tagNameCheck(e)) && (f.attributeNameCheck instanceof RegExp && A(f.attributeNameCheck, t) || f.attributeNameCheck instanceof Function && f.attributeNameCheck(t)) || t === "is" && f.allowCustomizedBuiltInElements && (f.tagNameCheck instanceof RegExp && A(f.tagNameCheck, n) || f.tagNameCheck instanceof Function && f.tagNameCheck(n)))) return false;
        } else if (!Se[t]) {
          if (!A(ve, $(n, Pe, ""))) {
    ...
    if (!t || Le(e)) return;
    const n = { attrName: "", attrValue: "", keepAttr: true, allowedAttributes: p, forceKeepAttr: void 0 };
    let c = t.length;
    for (; c--; ) {
      const _ = t[c], { name: d, namespaceURI: O, value: D } = _, j = m(d);
      let h = d === "value" ? D : $t(D);
      if (n.attrName = j, n.attrValue = h, n.keepAttr = true, n.forceKeepAttr = void 0, M(g.uponSanitizeAttribute, e, n), h = n.attrValue, We && (j === "id" || j === "name") && (re(d, e), h = Pt + h), Ee && A(/((--!?|])>)|<\/(style|title)/i, h)) {
        re(d, e);
        continue;
      }
      ...
      if (et(ot, j, h)) {
        if (E && typeof J == "object" && typeof J.getAttributeType == "function" && !O) switch (J.getAttributeType(ot, j)) {
          case "TrustedHTML": {
            h = E.createHTML(h);
            break;
          }
    ...
    let t = null;
    const n = Ze(e);
    for (M(g.beforeSanitizeShadowDOM, e, null); t = n.nextNode(); ) M(g.uponSanitizeShadowNode, t, null), Qe(t), nt(t), t.content instanceof b && i(t.content);
  ...
  return o.sanitize = function(i) {
    ...
    if (Re = !i, Re && (i = "<!-->"), typeof i != "string" && !Je(i)) if (typeof i.toString == "function") {
    ...
    if (ge || ye(e), o.removed = [], typeof i == "string" && (Y = false), Y) {
      if (i.nodeName) {
        const D = m(i.nodeName);
        if (!u[D] || B[D]) throw q("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (i instanceof fe) t = Ke("<!---->"), n = t.ownerDocument.importNode(i, true), n.nodeType === Z.element && n.nodeName === "BODY" || n.nodeName === "HTML" ? t = n : t.appendChild(n);
    else {
    ...
    if (v) {
      ...
      return (p.shadowroot || p.shadowrootmode) && (_ = It.call(s, _, true)), _;
    }
